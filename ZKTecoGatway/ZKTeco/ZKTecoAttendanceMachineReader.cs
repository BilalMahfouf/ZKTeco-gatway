...
public sealed record AttendenceMachine(int MachineNumber, string IpAddress, int Port);

public sealed class ZKTecoAttendanceMachineReader
{
   public ZKTecoAttendanceMachineReader(IZKemSessionFactory sessionFactory)
    ...
    CancellationToken cancellationToken)
    {
            ...
            ref workCode))
        {
            ...
            // Filter by badge if one was provided.
